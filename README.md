...
## Como apresentar (4 falas, ~5 min)
1. **Pesquisa e Documentação:** contexto, público e proposta de valor. O projeto está em desenvolvimento e em validação.
2. **Tecnologia e Desenvolvimento 1:** mostra o fluxo da demo (pista e depois verificação). Explica que é uma simulação.
3. **Tecnologia e Desenvolvimento 2:** integração aluno + professor + IA, acompanhamento, plataforma Web e expansão futura.
