...
- Logo no site: `.logo-full` (recorte por CSS da `20260922_223141000_iOS.jpg`, símbolo + nome, sem slogan/pilares) na seção Identidade (#mvv) e no rodapé. **Não** colocar logo no menu (ao lado do nome) nem no hero/banner: pedido explícito do usuário.
